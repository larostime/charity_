            ...
            if(isset($_POST['submit']))
            {
                ...
                if(isset($_FILES['image']['name']))
                {
                    ...
                    if($image_name != "")
                    {
                        ...
                        //Rename the Image
                        $image_name = "Ware_Category_".rand(000, 999).'.'.$ext; // e.g. Ware_Category_834.jpg
                ...
                {
                    //Category Updated
                    $_SESSION['update'] = "<div>Category Updated Successfully.</div>";
                    header('location:'.SITEURL.'admin/manage-category.php');
                }
                else
                {
                    //failed to update category
                    $_SESSION['update'] = "<div>Failed to Update Category.</div>";
                    header('location:'.SITEURL.'admin/manage-category.php');
                }
