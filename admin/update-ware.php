...
<?php 
    ...
    if(isset($_GET['id']))
    {
        ...
        $sql2 = "SELECT * FROM tbl_ware WHERE id=$id";
        //execute the Query
        ...
        <table class="tbl-30">
            ...
            <tr>
                <td>
                    ...
                    <input type="submit" name="submit" value="Update Ware" class="btn-primary">
                </td>
            </tr>
            ...
            if(isset($_POST['submit']))
            {
                ...
                if(isset($_FILES['image']['name']))
                {
                    ...
                    if($image_name!="")
                    {
                        ...
                        $image_name = "Ware-Name-".rand(0000, 9999).'.'.$ext; //THis will be renamed image
                        ...
                        if($current_image!="")
                        {
                            ...
                            if($remove==false)
                            {
                                ...
                                $_SESSION['remove-failed'] = "<div>Faile to remove current image.</div>";
                ...
                else
                {
                    ...
                    $_SESSION['update'] = "<div>Failed to Update Ware.</div>";
                    header('location:'.SITEURL.'admin/manage-ware.php');
                }
